...
public class Menu {
   ...
   */
  public int gestionar() throws NumberFormatException, IOException, EnteroNoValidoException {
    mostrar();
   ...
   * @throws NoEsEnteroException
   */
  private int recogerOpcion() throws NumberFormatException, EnteroNoValidoException {
    int opcion = -1;
    do {
